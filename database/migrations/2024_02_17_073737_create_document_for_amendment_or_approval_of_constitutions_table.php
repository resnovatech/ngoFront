...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('document_for_amendment_or_approval_of_constitutions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('document_for_amendment_or_approval_of_constitutions');
    }
};
