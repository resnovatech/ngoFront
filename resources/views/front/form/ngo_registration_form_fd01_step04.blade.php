                ...
                <div class="main active">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <p id="copy_of_chalan_text" class="text-danger"></p>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="">
                            ...
                            <p id="due_vat_pdf_text" class="text-danger"></p>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" required value="{{$nameOfBankGlobal}}" name="name_of_bank" class="form-control" id="">
                            </div>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                            <div class="mb-3">
