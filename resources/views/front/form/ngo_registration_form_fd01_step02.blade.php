...
<b>{{ $filename.'.'.$extension }}</b>
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">সংস্থার সম্ভাব্য /প্রত্যাশিত বার্ষিক বাজেটের উৎস<span class="text-danger">*</span> <span class="text-danger" style="font-size: 12px;">(Maximum 2 MB)</span></label>
                        <input type="file" accept=".pdf" name="annual_budget_file"  data-parsley-required class="form-control" id="annual_budget_file">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">সংস্থার সম্ভাব্য /প্রত্যাশিত বার্ষিক বাজেটের উৎস<span class="text-danger">*</span> <span class="text-danger" style="font-size: 12px;">(Maximum 2 MB)</span></label>
                        <input type="file" accept=".pdf" name="annual_budget_file"   class="form-control" id="annual_budget_file"/>
                        <small id="annual_budget_file_text" class="text-danger" style="font-size: 12px;"></small>
                    </div>
                    <b>{{ $filename.'.'.$extension }}</b>
                    @endif
