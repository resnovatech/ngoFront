...
<section>
  ...
  <b>{{ $filename.'.'.$extension }}</b>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="">In case of change of bank account number, copy of approval letter from Bureau should be attached: <span class="text-danger" style="font-size: 12px;">(Maximum 500 KB)</span></label>
...
<div class="modal-body">
<form method="post" action="{{ route('otherInformationAUpdate') }}" enctype="multipart/form-data" id="form"   data-parsley-validate="">
@csrf
