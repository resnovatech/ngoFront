                    ...
                    <div class="card-body">
                        <div class="name_change_box">
                            ...
                            <div class="no_name_change pt-4">
                                ...
                                <form action="{{ route('complain.store') }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                    @csrf
                                <div class="row">
...
@csrf
                                ...
                                <input type="text" required name="subject" value="" class="form-control" id=""
                                placeholder="">
