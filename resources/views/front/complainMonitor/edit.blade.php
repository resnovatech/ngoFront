                    ...
                    <div class="card-body">
                        <div class="name_change_box">
                            ...
                            <div class="no_name_change pt-4">
                                ...
                                <form action="{{ route('complain.update',$complainList->id) }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                    @csrf
                                    @method('PUT')
                                <div class="row">
...
@csrf
                                    <div class="mb-3 col-lg-12">
                                        <label for="" class="form-label">বিষয়<span class="text-danger">*</span></label>





                                <input type="text" required name="subject" value="{{ $complainList->subject }}" class="form-control" id=""
                                placeholder="">
                                    ...
                                    <div class="mb-3 col-lg-12">
                                        <label for="" class="form-label">বিস্তারিত বিবরণ<span class="text-danger">*</span></label>
                                        <textarea required name="des" class="form-control datepicker" id="summernote"
                                               placeholder="">{!! $complainList->description !!}</textarea>
                                    </div>
                                </div>
