    ...
    <div class="d-flex justify-content-between mb-4">
        ...
        <div class="p-2">
            <button class="btn btn-primary btn-custom" type="button" data-bs-toggle="modal"
                    data-bs-target="#mmdexampleModal">
...
<?php
            ...
            ?>
                    <div class="file-box-image">
                        ...
                        <div class="mt-2">
                            ...
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#reexampleModal{{ $all_all_ngo_member_doc->id  }}"><i class="fa fa-pencil"></i></button>
                    ...
                    <!--ddd-->
                    <div class="modal fade" id="reexampleModal{{ $all_all_ngo_member_doc->id  }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="reexampleModalLabel">{{ trans('form 8_bn.personal_info')}}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="form" method="post" action="{{ route('ngoMemberDocument.update',$all_all_ngo_member_doc->id) }}" enctype="multipart/form-data">
...
<div class="modal modal-xl fade" id="mmdexampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
