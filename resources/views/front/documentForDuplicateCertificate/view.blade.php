                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                        ...
                                        <a target="_blank"  href="{{route('duplicateCertificate',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_one'])}}" >
                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                        ...
                                        <a target="_blank"  href="{{route('duplicateCertificate',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_two'])}}" >
                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                       ...
                                       <a target="_blank"  href="{{route('duplicateCertificate',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_three'])}}" >
                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                       ...
                                       <a target="_blank"  href="{{route('duplicateCertificate',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_four'])}}" >
