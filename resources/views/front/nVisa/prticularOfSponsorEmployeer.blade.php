...
<div class="card-body">
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <input type="text" name="org_name" class="form-control" id="" required>
        </div>
    </div>
    <div class="mb-3 row">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-lg-8">
            ...
            <input type="text" name="recommendation_of_company_board" class="form-control"
