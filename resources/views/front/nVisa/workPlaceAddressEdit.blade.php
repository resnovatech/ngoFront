    ...
    <div class="row">
        <div class="mb-3 col-lg-4">
            ...
            <input type="text" class="form-control" id=""
                   placeholder="House/Plot/Holding/Village" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_house_no }}" name="work_house_no" required>
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">Flat/Appartment/Floor: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="Flat/Appartment/Floor" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_flat_no }}" name="work_flat_no" required>
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">Road Number: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="Road Number" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_road_no }}" name="work_road_no" required>
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">City/District: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="City/District" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_district }}" name="work_district" required>
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">Thana/Upazilla: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
            placeholder="Thana/Upazilla" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_thana }}" name="work_thana" required>
        </div>
