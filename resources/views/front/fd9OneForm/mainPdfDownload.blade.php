...
সংযুক্ত ,
        ...
        <p>{{ trans('fd_one_step_one.tt_2')}},{{ trans('fd_one_step_one.tt_3')}}</p> --}}
                ...
                <table style=" margin-top: 15px;width:100%">
                    ...
                    <tr>
                        <td style="text-align: right; padding-right: 14%" colspan="3"><img width="150" height="60" src="{{ asset('/') }}{{ $fd9OneList->digital_signature}}"/></td>
                    </tr>
                    <tr>
                        <td style="text-align: right; padding-right: 14%" colspan="3"><img width="150" height="60" src="{{ asset('/') }}{{ $fd9OneList->digital_seal}}"/></td>
                    </tr>
                </table>
