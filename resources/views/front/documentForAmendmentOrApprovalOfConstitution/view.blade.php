                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                        ...
                                        <a target="_blank"  href="{{route('approvalOfConstitution',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_one'])}}" >
                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                        ...
                                        <a target="_blank"  href="{{route('approvalOfConstitution',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_two'])}}" >
                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                       ...
                                       <a target="_blank"  href="{{route('approvalOfConstitution',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_three'])}}" >
                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                       ...
                                       <a target="_blank"  href="{{route('approvalOfConstitution',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_four'])}}" >
                                        গঠনতন্ত্রের কোন ধারা, উপধারা পরিবর্তন ও সংযোজনের বিষয়ে সাধারণ
                                       </a>
                            ...
                            <a href="">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center text-dark">
                                       ...
                                       <a target="_blank"  href="{{route('approvalOfConstitution',['id'=>$documentForDuplicateCertificate->id,'title'=>'file_five'])}}" >
