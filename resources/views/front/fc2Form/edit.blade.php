...
<section>
    ...
    <div class="mb-3 col-lg-6">
        ...
        <input type="text" name="person_tele_phone_number" value="{{ $fc2FormList->person_tele_phone_number }}"  class="form-control" id=""
               placeholder="">
    </div>
    <div class="mb-3 col-lg-6">
    ...
    <div class="mb-3 col-lg-6">
        ...
        <input type="text" name="person_email" value="{{ $fc2FormList->person_email }}" class="form-control" id=""
               placeholder="">
    </div>
                                    ...
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">টেলিফোন</label>
                                                    <input type="text" value="{{ $fc2FormList->foreigner_donor_telephone_number }}" name="foreigner_donor_telephone_number" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">ফ্যাক্স </label>
                                                    <input type="text" value="{{ $fc2FormList->foreigner_donor_fax }}" name="foreigner_donor_fax" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">ইমেইল নম্বর</label>
                                                    <input type="text" value="{{ $fc2FormList->foreigner_donor_email }}" name="foreigner_donor_email" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-12">
                                                    <label for="" class="form-label">জাতীয়তা/নাগরিকত্ব</label>
                                                    <input type="text" value="{{ $fc2FormList->foreigner_donor_nationality }}" name="foreigner_donor_nationality" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-12">
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">টেলিফোন</label>
                                                    <input type="text" value="{{ $fc2FormList->organization_telephone_number }}" name="organization_telephone_number" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">ফ্যাক্স নম্বর</label>
                                                    <input type="text" value="{{ $fc2FormList->organization_fax }}" name="organization_fax" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">ইমেইল </label>
                                                    <input type="text" value="{{ $fc2FormList->organization_email }}" name="organization_email" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">ওয়েবসাইট</label>
                                                    <input type="text" value="{{ $fc2FormList->organization_website }}" name="organization_website" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-12">
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    ...
                                                    <input type="text" value="{{ $fc2FormList->organization_ceo_designation }}" name="organization_ceo_designation" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    ...
                                                    <input type="text" value="{{ $fc2FormList->organization_name_of_executive_responsible_for_bd_designation }}" name="organization_name_of_executive_responsible_for_bd_designation" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">সংস্থার উদ্দেশ্যসমূহ</label>
                                                    <input type="text" value="{{ $fc2FormList->objectives_of_the_organization }}" name="objectives_of_the_organization" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <select name="organization_letter_of_commitment" id="" class="form-control">
                                            <option value="হ্যাঁ" {{'হ্যাঁ' == $fc2FormList->organization_letter_of_commitment ? 'selected':''}}>হ্যাঁ</option>
                                            <option value="না" {{ 'না' == $fc2FormList->organization_letter_of_commitment ? 'selected':''}}>না</option>
                                        </select>
                                    </div>
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="mb-3 col-lg-6">
                                                    ...
                                                    <input type="number" value="{{ $fc2FormList->organization_amount_of_foreign_currency }}" name="organization_amount_of_foreign_currency" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">সমপরিমাণ বাংলাদেশী টাকা</label>
                                                    <input type="number" value="{{ $fc2FormList->equivalent_amount_of_bd_taka }}" name="equivalent_amount_of_bd_taka" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-12">
                                                    <label for="" class="form-label">পণ্যসামগ্রী (বাংলাদেশী মুদ্রায় আনুমানিক মূল্য)</label>
                                                    <input type="number" value="{{ $fc2FormList->commodities_value_in_bangladeshi_currency }}" name="commodities_value_in_bangladeshi_currency" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    ...
                                                    <input type="text" value="{{ $fc2FormList->bank_account_name }}" name="bank_account_name" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                                <div class="mb-3 col-lg-6">
                                                    <label for="" class="form-label">ব্যাংক হিসাব নম্বর</label>
                                                    <input type="text" value="{{ $fc2FormList->bank_account_number }}" name="bank_account_number" class="form-control" id=""
                                                           placeholder="">
                                                </div>
                                            </div>
                                        </div>
