                                    ...
                                    <div class="mb-3 col-lg-12 mt-3">
                                     ...
                                     <div class="mb-3">
                                        <label for="" class="form-label"> আবেদনকারীর নাম: <span class="text-danger">*</span></label>
                                             <input type="text" readonly data-parsley-required value="{{$chiefNameGlobal}}" name="chief_name"  class="form-control" id="mainName" placeholder="আবেদনকারীর নাম">
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label"> আবেদনকারীর পদবি: <span class="text-danger">*</span></label>
                                            <input type="text" readonly data-parsley-required value="{{$chiefDesignationGlobal}}"  name="chief_desi"  class="form-control"  placeholder="আবেদনকারীর পদবি">
                                        </div>
