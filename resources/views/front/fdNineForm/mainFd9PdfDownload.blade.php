...
<p>{{ trans('fd_one_step_one.tt_2')}},{{ trans('fd_one_step_one.tt_3')}}</p>
        ...
        {{-- <table style="text-align: right; margin-top: 100px;  width:100%">
            ...
            <tr>
                ...
                <td style="width:35%; text-align: left; width: 20%">:  {{ $fdNineData->chief_name }}</td>
            </tr>
            <tr>
                <td style="text-align: right; width: 80%"> {{ trans('fd_one_step_one.tt_6')}}</td>
                <td style="width:35%; text-align: left; width: 20%">:  {{ $fdNineData->chief_desi }}</td>
            </tr>
        ...
        <table style=" margin-top: 10px;width:100%">
            ...
            <tr>
                ...
                <td style="width:30%; text-align: left;">: {{ $fdNineData->chief_name }}</td>
            </tr>
            <tr>
                <td style="width: 65%"></td>
                <td style="text-align: left; width: 5%;">{{ trans('fd_one_step_one.tt_6')}}</td>
                <td style="width:30%; text-align: left;">: {{ $fdNineData->chief_desi }}</td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:30%; text-align: left;">: {{  App\Http\Controllers\NGO\CommonController::englishToBangla($fdNineData->created_at->format('d/m/Y')) }}</td>
