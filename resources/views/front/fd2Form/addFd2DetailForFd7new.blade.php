...
<section>
   ...
   <tr>
    ...
    <th style="text-align: center;">
        <input type="text" required value="{{ $fd7FormList->ngo_name }}" name="ngo_name" class="form-control" id=""
                                                   placeholder="সংস্থার নাম">
                                                   <input type="text" required class="form-control mt-3" value="{{ $fd7FormList->ngo_address }}" name="ngo_address" id=""
...
<tr>
    ...
    <th style="text-align: center;">
        <input type="text" required value="{{ $fd7FormList->ngo_prokolpo_name }}" name="ngo_prokolpo_name" class="form-control" id=""
...
<tr>
    ...
    <th style="text-align: center;">
        ...
        <input type="text" required value="{{ $fd7FormList->ngo_prokolpo_start_date }}" name="ngo_prokolpo_start_date" class="form-control datepickerOne mt-2" id=""
        placeholder="আরম্ভের তারিখ">

        <input type="text" required value="{{ $fd7FormList->ngo_prokolpo_end_date }}" name="ngo_prokolpo_end_date" class="form-control datepickerOne mt-2" id=""
...
<tr>
                                        ...
                                        <input type="hidden" id="fd7_form_id" name="fd7_form_id" value="{{ base64_encode($fd7Id) }}" />
...
<script>
    ...
    $("#dynamic-ar").click(function () {
        ++i;
        $("#dynamicAddRemove").append('<tr><td><input type="text"  name="file_name[]" class="form-control" id=""placeholder=""></td><td><input type="file" name="file[]" accept=".pdf" class="form-control" id="" placeholder=""></td><td><button type="button" class="btn btn-outline-danger remove-input-fieldnn"><i class="bi bi-file-earmark-x-fill"></i></button></td></tr>');
    });
    $(document).on('click', '.remove-input-fieldnn', function () {
