                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="text" required class="form-control" value="{{ $fd7FormList->ngo_address }}" name="ngo_address" id=""
                                                   placeholder="">
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input type="text" required value="{{ $fd7FormList->ngo_prokolpo_start_date }}" name="ngo_prokolpo_start_date" class="form-control datepickerOne" id=""
                                                   placeholder="">
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">সমাপ্তির তারিখ <span class="text-danger">*</span></label>
                                            <input type="text" required value="{{ $fd7FormList->ngo_prokolpo_end_date }}" name="ngo_prokolpo_end_date" class="form-control datepickerOne" id=""
                                                   placeholder="">
                                        </div>
                                    </div>
                                    <div class="row">
