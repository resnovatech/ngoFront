...
@section('body')
<section>
    <form action="{{ route('updateFd2DetailForFd3') }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
        @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="name_change_box">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input type="text" required value="{{ $fd2FormList->ngo_prokolpo_start_date }}" name="ngo_prokolpo_start_date" class="form-control datepickerOne" id=""
                                                   placeholder="">
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">সমাপ্তির তারিখ <span class="text-danger">*</span></label>
                                            <input type="text" required value="{{ $fd2FormList->ngo_prokolpo_end_date }}" name="ngo_prokolpo_end_date" class="form-control datepickerOne" id=""
                                                   placeholder="">
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-md-3 mt-2">
                                    <div class="card card-custom-color">
                                        <div class="card-body">
                                            ...
                                            <p><b>{{ $fd2OtherInfoAll->file_name }}:</b> <a target="_blank" href="{{ route('downloadFd2DetailForFd3',$fd2OtherInfoAll->id) }}" class="btn btn-custom next_button btn-sm" >
                                        ...
                                        <div class="card-footer">
                                            <button type="button" class="btn btn-custom next_button btn-sm" data-bs-toggle="modal" data-bs-target="#mmexampleModal{{ $key+1 }}">
                                              ...
                                              <a href="{{ route('deleteFd2DetailForFd3',$fd2OtherInfoAll->id) }}}" class="btn btn-sm btn-outline-danger"><i
                            ...
                            <form method="post" action="{{ route('fd2ForFd3PdfUpdate') }}" enctype="multipart/form-data" id="form">
                            @csrf
