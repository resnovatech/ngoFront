   ...
   <tr>
    ...
    <th style="text-align: center;">
        <input type="text" required value="{{ $fd6FormList->ngo_name }}" name="ngo_name" class="form-control" id=""
                                                   ...
                                                   <input type="text" required class="form-control mt-3" value="{{ $fd6FormList->ngo_address }}" name="ngo_address" id=""
...
<tr>
    ...
    <th style="text-align: center;">
        ...
        <input type="text" required value="{{ $fd6FormList->ngo_prokolpo_start_date }}" name="ngo_prokolpo_start_date" class="form-control datepickerOne mt-2" id=""
        placeholder="আরম্ভের তারিখ">

        <input type="text" required value="{{ $fd6FormList->ngo_prokolpo_end_date }}" name="ngo_prokolpo_end_date" class="form-control datepickerOne mt-2" id=""
