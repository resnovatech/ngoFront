<form method="post" action="{{ route('fcOneOtherPdfListUpdate') }}" enctype="multipart/form-data" id="form">
    @csrf
    ...
    <div class="mb-3">
        ...
        ?>
    <label for="exampleFormControlInput1" class="form-label">{{ $fd2OtherPdf->file_title }}:</label>
