                ...
                <div class="card">
                  ...
                  <div class="d-flex justify-content-between mt-3">
                    ...
                    <div class="">
                        ...
                        <a target="_blank" href="{{ route('fc1pdfview',base64_encode($fc1FormList->id)) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="{{ trans('form 8_bn.download_pdf')}}"  >
                ...
                <div class="card mt-5">
                  ...
                  <div class="d-flex justify-content-between mt-3">
                    ...
                    <div class="">
                        ...
                        <a target="_blank" href="{{ route('fd2pdfviewdfc1',base64_encode($fc1FormList->id)) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="{{ trans('form 8_bn.download_pdf')}}"  >
                            <i class="fa fa-print"></i>
                        </a>
