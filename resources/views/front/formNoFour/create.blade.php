                    ...
                    <div class="card-body">
                        <div class="name_change_box">
                            ...
                            @include('flash_message')
                                    ...
                                    <form action="{{ route('formNoFour.store') }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                        @csrf
                                    ...
                                    @endif
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input type="text" required name="prokolpo_duration" value="" class="form-control" id=""
                                                   placeholder="">
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">প্রকল্প অনুমোদন পত্র নং <span class="text-danger">*</span></label>
                                            <input type="text" required name="prokolpo_permission_no" value="" class="form-control" id=""
                                                   placeholder="">
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">প্রকল্প অনুমোদন তারিখ <span class="text-danger">*</span></label>
                                            <input type="text" required name="prokolpo_date" class="form-control datepickerOne" value="" id=""
                                                   placeholder="">
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">প্রতিবেদনকালীন সময় <span class="text-danger">*</span></label>
                                            <input type="text" required name="prokolpo_report_time" value="" class="form-control" id=""
                                                   placeholder="">
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">মোট প্রকল্প ব্যয় <span class="text-danger">*</span></label>
                                            <input type ="number" required name="prokolpo_total_cost" class="form-control" id="" placeholder="">
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">এ এলাকার জন্য বরাদ্দের পরিমাণ <span class="text-danger">*</span></label>
                                            <input type="text" required name="allocation_amount" class="form-control" id=""
                                                   placeholder="" value="">
                                        </div>

                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">জেলা/উপজেলা  ভিত্তিক মোট ব্যয়<span class="text-danger">*</span></label>
                                            <input type="text" required name="district_upazila_wise_total_expenditure" class="form-control" id=""
                                                   placeholder="" value="">
                                        </div>

                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">জেলা /উপজেলা ভিত্তিক বার্ষিক বরাদ্দ <span class="text-danger">*</span></label>
                                            <input type="text" required name="district_upazila_wise_annual_allocation" class="form-control" id=""
                                                   placeholder="" value="">
                                        </div>
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input type="text" required name="sign_board_avaiable_or_not" class="form-control" id=""
                                                   placeholder="" value="">
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table table-bordered text-center" id="dynamicAddRemove">
                                                            ...
                                                            <tr>
                                                                <td><input required type="text" name="work_area[]"
                                                                    class="form-control" placeholder="কর্ম এলাকা" /></td>
                                                                <td><textarea required placeholder="খাতের বিবরণ" name="sector_detail[]" class="form-control"></textarea></td>
                                                                <td><input required type="text" name="target_real[]"
                                                                    class="form-control" placeholder="বাস্তব" /></td>
                                                                <td><input required type="text" name="target_financial[]"
                                                                    class="form-control" placeholder="আর্থিক" /></td>
                                                                    <td><input required type="text" name="achievement_real[]"
                                                                        class="form-control" placeholder="বাস্তব" /></td>
                                                                    <td><input required type="text" name="achievement_financial[]"
                                                                        class="form-control" placeholder="আর্থিক" /></td>
                                                                <td><input required type="text" name="comulative_achievement[]"
                                                                    class="form-control" placeholder="পুঞ্জীভূত অর্জন" /></td>
                                                                <td><textarea  placeholder="মন্তব্য" name="comment[]" class="form-control"></textarea></td>
