...
<div class="d-grid d-md-flex justify-content-end">
    <button type="button" disabled class="btn btn-registration"
            onclick="location.href = '{{ route('fdFourForm.create') }}';">নতুন ফরম যোগ করুন
    </button>
</div>
...
@else
                            ...
                            <div class="no_name_change pt-4">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($fdFourFormList as $key=>$fdFourFormListAll)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(  $fdFourFormListAll->status == 'Ongoing' || $fdFourFormListAll->status == 'Accepted')

                                            @else

                                            <a  href="{{ route('fdFourForm.edit',base64_encode($fdFourFormListAll->id)) }}" class="btn btn-sm btn-outline-primary"> <i class="fa fa-pencil"></i> </a>

                                            @endif
                                            <a  href="{{ route('fdFourForm.show',base64_encode($fdFourFormListAll->id)) }}" class="btn btn-sm btn-outline-success"> <i class="fa fa-eye"></i> </a>
