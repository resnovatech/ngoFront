...
<span style="text-align: justify">আমি নিম্নস্বাক্ষরকারী এই মর্মে প্রত্যয়ন করছি যে, আমার  <input type="text"  name="farm_name" value="{{ $fdFourFormList->farm_name }}"/> সিএফার্ম কর্তৃক <input type="text"  name="farm_detail" value="{{ $fdFourFormList->farm_detail }}"/> নিম্নবর্ণিত সংস্থার বর্ণিত প্রকল্পের <input type="text"  name="prokolpo_duration" value="{{ $fdFourFormList->prokolpo_duration }}"/> মেয়াদের হিসাব নিরীক্ষা করা হয়েছে। নিরীক্ষাকালে যাবতীয় বহি, বিল-ভাউচার ও প্রয়োজনীয় প্রমাণক যাচাই করা হয়েছে। নিরীক্ষাকৃত হিসাব অনুসারে প্রাপ্ত তথ্যাদি নিম্নরূপ : </span>
                                        ...
                                        <table class="table table-bordered" style="width:100%">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                    ...
                                                    <input type="text" placeholder="এনজিও'র নাম" required name="ngo_name" value="{{ $fdFourFormList->ngo_name }}" class="form-control" id=""
                                                    placeholder="">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                    <input type="text" required name="registration_number" value="{{ $fdFourFormList->registration_number }}" class="form-control " id=""
                                                ...
                                                <th style="text-align: center;">
                                                    <div class="row">
                                                        <div class="mb-3 col-lg-12">
                                                            ...
                                                            <input type="text" placeholder="সংস্থার ঠিকানা" required name="ngo_address" class="form-control" value="{{ $fdFourFormList->ngo_address }}" id=""
                                                                   >
                                                        </div>

                                                        <div class="mb-3 col-lg-12">

                                                            <input type="text" placeholder="টেলিফোন" required name="ngo_telephone" value="{{ $fdFourFormList->ngo_telephone }}" class="form-control" id=""
                                                                   >
                                                        </div>
                                                        <div class="mb-3 col-lg-12">
                                                            ...
                                                            maxlength = "11" data-parsley-required minlength="11"  data-parsley-trigger=“keyup” name="ngo_mobile_number" value="{{ $fdFourFormList->ngo_mobile_number }}" class="form-control" id=""
                                                                  >
                                                        </div>
                                                        <div class="mb-3 col-lg-12">

                                                            <input placeholder="ইমেইল ঠিকানা" type="text" required name="ngo_email" class="form-control" id=""
                                                                   value="{{ $fdFourFormList->ngo_email }}">
                                                        </div>


                                                        <div class="mb-3 col-lg-12">

                                                            <input placeholder="ওয়েবসাইট" type="text" required value="{{ $fdFourFormList->ngo_website }}" name="ngo_website" class="form-control" id=""
                                                                   >
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                        ...
                                                        <input type="text" required value="{{ $fdFourFormList->prokolpo_name }}" name="prokolpo_name" value="" class="form-control" id=""
                                                               placeholder="প্রকল্পের নাম">


                                                        <input type="text" required value="{{ $fdFourFormList->prokolpo_duration_one }}" name="prokolpo_duration_one" value="" class="form-control mt-2" id=""
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                    ...
                                                    <input type="text" required value="{{ $fdFourFormList->exam_time }}" name="exam_time" value="" class="form-control" id=""
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                    ...
                                                    <input type="text" required value="{{ $fdFourFormList->start_balance }}" name="start_balance" class="form-control " value="" id=""
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                    ...
                                                    <input type="text" value="{{ $fdFourFormList->foreign_grant_taken_exam_year }}" required name="foreign_grant_taken_exam_year" value="" class="form-control" id=""
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                    ...
                                                    <input type="text" required value="{{ $fdFourFormList->foreign_grant_cost_exam_year }}" name="foreign_grant_cost_exam_year" class="form-control " value="" id=""
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                    ...
                                                    <input type="text" required value="{{ $fdFourFormList->foreign_grant_remaining_exam_year }}" name="foreign_grant_remaining_exam_year" class="form-control" id=""
