                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;">
                                                    ...
                                                    <div class="mb-3 col-lg-12">
                                                        ...
                                                        <input type="text" required name="project_approval_letter_memo_number" class="form-control" id=""
                                                    ...
                                                    <div class="mb-3 col-lg-12">
                                                        ...
                                                        <input type="text" required name="project_approval_letter_date" class="form-control datepickerOne" id=""
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="bank_account_number" class="form-control mt-2" id=""
                                            ...
                                            <tr>
                                                <td colspan="3"> <input type="text" name="administration_involved" class="form-control" id=""
