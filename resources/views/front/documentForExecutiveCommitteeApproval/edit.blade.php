            ...
            <div class="col-lg-9 col-md-6 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('executiveCommitteeApproval.update',$documentForDuplicateCertificate->id) }}" enctype="multipart/form-data" id="form" data-parsley-validate="">
