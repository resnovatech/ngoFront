...
<div class="container">
    ...
    <div class="action">
        ...
        {{-- <input type="file"   style="float:left; width: 250px" name="digital_seal" accept="image/png" class="form-control file" id="fileOne">
...
<script type="text/javascript">
    ...
    document.querySelector('#btnCrop').addEventListener('click', function(){
        ...
        document.querySelector('.croppedInputss').innerHTML = "";
        document.querySelector('.croppedInputss').innerHTML += '<img src="'+img+'">';
        $("input[name='image_seal_base64']").val(img);
