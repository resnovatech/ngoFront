                            ...
                            <div class="card mt-3 card-custom-color">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('fd6Form.update',$fd6FormList->id) }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" id="mainEditId" value="1"/>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" required name="ngo_registration_number" value="{{ $fd6FormList->ngo_registration_number }}" class="form-control mb-3" id=""
                                                                   placeholder="ব্যুরোর নিবন্ধন নং">
                                                            <input type="text" required name="ngo_registration_date" value="{{ date("d-m-Y", strtotime($fd6FormList->ngo_registration_date)) }}" class="form-control datepickerOne" id=""
                                                                   placeholder="তারিখ">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="text" required name="ngo_last_renew_date" value="{{ date("d-m-Y", strtotime($fd6FormList->ngo_last_renew_date)) }}"  class="form-control mb-3 datepickerOne" id="">
                                                            <label for="" class="form-label">মেয়াদ উত্তীর্ণের তারিখ</label>
                                                            <input type="text" required name="ngo_expiration_date" value="{{ date("d-m-Y", strtotime($fd6FormList->ngo_expiration_date)) }}"  class="form-control datepickerOne" id="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <input type="text" required value="{{ $fd6FormList->ngo_website }}" name="ngo_website" class="form-control" id=""
                                                   placeholder="">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" value="{{ $fd6FormList->ngo_prokolpo_name }}" name="ngo_prokolpo_name" required class="form-control" id=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" value="{{ $fd6FormList->ngo_prokolpo_start_date }}" name="ngo_prokolpo_start_date" required class="form-control datepickerOne" id="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:40px;">খ)</td>
                                                        ...
                                                        <td>
                                                            <input type="text" value="{{ $fd6FormList->ngo_prokolpo_end_date }}" name="ngo_prokolpo_end_date" required class="form-control datepickerOne" id="">
                                                        </td>
                                                    </tr>
                                                    <tr>
