                            ...
                            <div class="card mt-3 card-custom-color">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('fd6StepFourMainUpdate') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="fd6AdjoiningAListId" id="fd6AdjoiningAListId" value="{{ $fd6AdjoiningAList->id }}"/>
                                        <input type="hidden" name="fd6AdjoiningCListId" id="fd6AdjoiningCListId" value="{{ $fd6AdjoiningCList->id }}"/>
                                        <input type="hidden" name="fd6AdjoiningDListId" id="fd6AdjoiningDListId" value="{{ $fd6AdjoiningDList->id }}"/>
...
<tr>
    ...
    <td>নগদ</td>
    <td>
        <input class="form-control" value="{{ $fd6AdjoiningAList->grant_amount_in_cash }}" name="grant_amount_in_cash" type="text" placeholder="নগদ">
    </td>
</tr>
<tr>
    ...
    <td>
        <input class="form-control" value="{{ $fd6AdjoiningAList->strategic_coperation }}" name="strategic_coperation" type="text"
...
<tr>
    ...
    <td>
        <input name="help_with_product" value="{{ $fd6AdjoiningAList->help_with_product }}" class="form-control" type="text"
...
<tr>
    ...
    <td>অন্যান্য</td>
    <td>
        <input name="other" value="{{ $fd6AdjoiningAList->other }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="project_implementation_area" value="{{ $fd6AdjoiningAList->project_implementation_area }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="other_information_note" value="{{ $fd6AdjoiningAList->other_information_note }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input accept=".pdf" name="copy_of_contract" class="form-control" type="file"
               ...
               $file_path = url($fd6AdjoiningAList->copy_of_contract);
...
<tr>
    ...
    <td>
        <input name="proof_of_land_ownership" value="{{ $fd6AdjoiningCList->proof_of_land_ownership }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="land_development_tax" value="{{ $fd6AdjoiningCList->land_development_tax }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="engineer_name" value="{{ $fd6AdjoiningCList->engineer_name }}" class="form-control" type="text"
               placeholder="প্রকৌশল ডিজাইন (প্রকৌশলীর নাম) ">
    <br>
    <input name="engineer_desi" value="{{ $fd6AdjoiningCList->engineer_desi }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="construction_layout" accept=".pdf" class="form-control" type="file"
               placeholder=" নির্মাণের লে-আউট প্লান  ">

               @if(empty($fd6AdjoiningCList->construction_layout))
               ...
               $file_path = url($fd6AdjoiningCList->construction_layout);
               $filename  = pathinfo($file_path, PATHINFO_FILENAME);
...
<tr>
    ...
    <td>
        <input name="estimated_expenses" value="{{ $fd6AdjoiningCList->estimated_expenses }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="prokolpo_name" value="{{ $fd6AdjoiningDList->prokolpo_name }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="prokolpo_duration" value="{{ $fd6AdjoiningDList->prokolpo_duration }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="total_allocation" value="{{ $fd6AdjoiningDList->total_allocation }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="total_allocation_prokolpo_area" value="{{ $fd6AdjoiningDList->total_allocation_prokolpo_area }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="total_benificiare" value="{{ $fd6AdjoiningDList->total_benificiare }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="total_benificiare_prokolpo_area" value="{{ $fd6AdjoiningDList->total_benificiare_prokolpo_area }}" class="form-control" type="text"
...
<tr>
    ...
    <td>
        <input name="donor_name" class="form-control" value="{{ $fd6AdjoiningDList->donor_name }}" type="text"
               placeholder="দাতা সংস্থার নাম ">
                                    ...
                                    <div class="d-grid d-md-flex justify-content-md-end">
                                        ...
                                        <a href="{{ route('fd6StepThreeEdit',base64_encode($fd6Id)) }}" class="btn btn-danger"
