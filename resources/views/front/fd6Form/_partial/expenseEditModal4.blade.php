<div class="modal modal-xl fade" id="expenseEditModal4"  aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <textarea required name="comment_grant" class="form-control" id="comment_grantfd64" placeholder="">{{ $fd6FormList->total_donors_comment }}</textarea>
                            </div>
                        </div>


                        <a id="fd64"  class="btn btn-registration GrantAjaxEdit">আপডেট করুন</a>
                    </div>
                </div>
