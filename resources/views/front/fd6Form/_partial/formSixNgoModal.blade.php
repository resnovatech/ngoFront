<!--modal-->
<div class="modal modal-xl fade" id="formSixModal"  aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <input type="text" name="work_detail" class="form-control" id="work_detail0"
                                        placeholder="">
                                    </div>

                                    <div class="col-lg-6 mb-3">
                                        <label for="" class="form-label">লক্ষমাত্রা(ভৌত)<span class="text-danger">*</span></label>
                                        <input type="text"  name="physical_goals" class="form-control" id="physical_goals0"
                                        placeholder="" >
                                    </div>
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input type="text"  name="physical_achievment" class="form-control" id="physical_achievment0"
                                        placeholder="" >
                                    </div>

                                    <div class="col-lg-6 mb-3">
                                        <label for="" class="form-label">বরাদ্দ(আর্থিক)<span class="text-danger">*</span></label>
                                        <input type="text"  name="financial_allocation" class="form-control" id="financial_allocation0"
                                        placeholder="" >
                                    </div>

                                    <div class="col-lg-6 mb-3">
                                        <label for="" class="form-label">ব্যয়(আর্থিক)<span class="text-danger">*</span></label>
                                        <input type="text"  name="financial_cost" class="form-control" id="financial_cost0"
                                        placeholder="" >
                                    </div>
