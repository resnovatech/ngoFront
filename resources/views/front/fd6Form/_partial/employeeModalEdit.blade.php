                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                                ...
                                <input type="text" required name="name" value="{{ $employeeDataPostLists->name }}" class="form-control" id="name{{ $employeeDataPostLists->id }}"
                                placeholder="কর্মকর্তা-কর্মচারীর নাম">
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label for="" class="form-label">কর্মকর্তা-কর্মচারীর পদবি<span class="text-danger">*</span></label>
                                <input type="text" required name="designation" value="{{ $employeeDataPostLists->designation }}" class="form-control" id="designation{{ $employeeDataPostLists->id }}"
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <input type="text" required name="nationality" value="{{ $employeeDataPostLists->nationality }}" class="form-control" id="nationality{{ $employeeDataPostLists->id }}"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" required name="duration" value="{{ $employeeDataPostLists->duration }}" class="form-control" id="duration{{ $employeeDataPostLists->id }}"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" required name="educational_qualification" value="{{ $employeeDataPostLists->educational_qualification }}" class="form-control" id="educational_qualification{{ $employeeDataPostLists->id }}"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" required name="experience" value="{{ $employeeDataPostLists->experience }}" class="form-control" id="experience{{ $employeeDataPostLists->id }}"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" required name="responsibility" value="{{ $employeeDataPostLists->responsibility }}" class="form-control" id="responsibility{{ $employeeDataPostLists->id }}"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" required name="salary_from_this_project" value="{{ $employeeDataPostLists->salary_from_this_project }}" class="form-control" id="salary_from_this_project{{ $employeeDataPostLists->id }}"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" required name="salary_from_other_project" value="{{ $employeeDataPostLists->salary_from_other_project }}" class="form-control" id="salary_from_other_project{{ $employeeDataPostLists->id }}"
